            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Alica Azwa Nayla</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Alica Azwa Nayla - Web Developer
              ...
              <!-- =============== ISI TABEL ADA DI SINI =============== -->
                <table class="table table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td>
    <a href="ubah_data.php?id=<?= $data['id'] ?>" class="btn btn-success btn-sm">Edit</a>
    <a href="hapus_data.php?id=<?= $data['id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?');" class="btn btn-danger btn-sm">Hapus</a>
</td>
